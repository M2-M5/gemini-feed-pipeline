...
| attributeName | "ApplicationRole" | Mandatory | 322 |
| attributeValueValue | Map include "Activity/Role" column source file | Mandatory | 450 |
| definition-English Desc | Definitions shall be from GLOSSARY.xlsx Definitions displays after attriabuteValueValue matched applicationRole | Mandatory | 1024 |
| definition-French Desc | | Optional | 1024 |
...
| entitlement | | Conditional | 450 each, Multivalued attributes |
| applicationRole | Map this field to include "Activity/Role" column from the source file. Multiple roles should then be separated by a semicolon ";". | Conditional | 450 each, Multivalued attributes |
